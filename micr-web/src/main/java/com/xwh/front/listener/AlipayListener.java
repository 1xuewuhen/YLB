...
public class AlipayListener {
    ...
    @DubboReference(interfaceClass = AlipayOrderSn.class,version = "1.0")
    private AlipayOrderSn alipayOrderSn;
	...
	*/
        if (signVerified) {//验证成功
            ...
            map.put("uid",vo.getBody());
            map.put("recharge_no",out_trade_no);
            map.put("recharge_money",vo.getTotal_amount());
